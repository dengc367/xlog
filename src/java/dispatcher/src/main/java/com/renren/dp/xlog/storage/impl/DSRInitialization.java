...
public class DSRInitialization extends StorageRepositoryInitialization {
  ...
  public void initialise() {
    ...
    File slaveLogDir = new File(storePath + "/"
    ...
    check(cacheLogDir, logFileNum, suffixFileFilter,
        Constants.LOG_WRITE_FINISHED_SUFFIX);
    check(slaveLogDir, logFileNum, suffixFileFilter,
        Constants.LOG_WRITE_ERROR_SUFFIX);
  }
}
