...
public class DefaultHABalancer implements HABalancerI {
  ...
  private final static Logger logger = LoggerFactory
      .getLogger(DefaultHABalancer.class);
  ...
  public boolean checkBalanceCondition(int slotID) throws KeeperException,
    ...
    synchronized (this) {
      List<String> list = conn.get().getChildren(clusterPath + "/" + slotID,
          false);
  ...
  private static Map.Entry<String, Integer>[] getSortedHashtableByValue(
    ...
    Arrays.sort(entries, new Comparator() {
      public int compare(Object arg0, Object arg1) {
        Integer key1 = Integer
            .valueOf(((Map.Entry) arg0).getValue().toString());
        Integer key2 = Integer
            .valueOf(((Map.Entry) arg1).getValue().toString());
